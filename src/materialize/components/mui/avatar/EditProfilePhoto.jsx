...
function EditProfilePhoto(props) {
  const {
    onChange, title, openAvatarModal, onCloseModal, avatar, username,
  } = props
  ...
  const [picture, setPicture] = useState({
    ...
    img: '',
    zoom: 2,
    croppedImg: avatar || 'https://upload.wikimedia.org/wikipedia/commons/0/09/Man_Silhouette.png',
  })
  ...
  const handleSave = () => {
    if (editor) {
      ...
      const file = dataURLtoFile(croppedImg, filename)
          ...
          ? (
            ...
            >
              ...
              <CustomAvatar
                ...
                variant="rounded"
                sx={{
                  width: 120, height: 120, mb: 4, mt: 2,
                }}
              />
              <Divider sx={{ width: '100%', mb: 4 }} />
              <Box sx={{
              ...
              >
                ...
                <input
                  ...
                  id="select-image"
                  style={{
                    height: 1, width: 1, overflow: 'hidden', padding: 0, whiteSpace: 'nowrap', position: 'absolute', display: 'block', border: 0, margin: -1,
                  }}
                />
                <Button
                  variant="contained"
